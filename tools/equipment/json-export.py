...
oc.write("//gunrange icon cost initiative spotrange bombercode hardatk id softatk airdef fuel rangedefmod airatk movmethod navalatk movpoints grounddef class target name country closedef ammo\n");
oc.write("var equipment_condensed = ");
out = json.dumps(eqcdict, sort_keys=True, separators=(',',':'))
oc.write(out)

jsloader = l.readlines();
for i in jsloader:
    oc.write("%s" % i);
